...
class Main extends Sprite
{
	...
	public var flagvar:Flags = new Flags(); // This is the flag variable, it's used to store flags for the game, though it's only used for a few things right now.
	...
	**/
	public static var gameWeeks:Array<Dynamic> = [
		...
		[
			['piracy-check', 'Overflow', 'dbdos'],
			['nobody', 'nobody', 'nobody'],
			[FlxColor.fromRGB(86, 86, 86)],
			"CRACKED CATASTROPHE"
		]
	];
	...
	public function new()
	{
		...
		**/
		...
		//GDD here, slippin in a little bit of code here to change up the window title if the player's beaten the game
		if (flagvar.hasBeatStory == true)
			Application.current.window.title = "Friday Night Funkin' Cracked Catastrophe";
	...
	function onCrash(e:UncaughtErrorEvent):Void
	{
		...
		errMsg += "\nAw fuck, an uncaught error: " + e.error + "\nDo me a favour and let me know in the thread.";
