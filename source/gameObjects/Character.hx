...
class Character extends FNFSprite
{
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'nobody':
				//it's times like this where i REALLY wish that this bitch had an offset editor
				//i'd make one myself but i have no fucking idea how to do that, even after looking at base funkin's editor.
				frames = Paths.getSparrowAtlas('characters/nobody');
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
			...
			case 'nobodyIcon':
				//i'm retarded and fucked up the directions for nobody's left and right animations ;-;
				frames = Paths.getSparrowAtlas('characters/nobodyIcon');
				animation.addByPrefix('idle', 'Nobody Icon Idle', 24, false);
				animation.addByPrefix('singUP', 'Nobody Icon Up', 24, false);
				animation.addByPrefix('singLEFT', 'Nobody Icon Right', 24, false);
				animation.addByPrefix('singRIGHT', 'Nobody Icon Left', 24, false);
				animation.addByPrefix('singDOWN', 'Nobody Icon Down', 24, false);

				playAnim('idle');

			case 'bfIcon':
				//oh god this is gonna fucking suck isn't it
				//update: didn't really suck, shit just kinda worked lmao
				frames = Paths.getSparrowAtlas('characters/bfIcon');
				animation.addByPrefix('idle', 'BF Icon Idle', 24, false);
				animation.addByPrefix('singUP', 'BF Icon Up', 24, false);
				animation.addByPrefix('singLEFT', 'BF Icon Left', 24, false); //might need to reverse this and right if i end up fucking up
				animation.addByPrefix('singRIGHT', 'BF Icon Right', 24, false);
				animation.addByPrefix('singDOWN', 'BF Icon Down', 24, false);
				animation.addByPrefix('singUPmiss', 'BF Icon Miss', 24, false);
				animation.addByPrefix('singLEFTmiss', 'BF Icon Miss', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'BF Icon Miss', 24, false);
				animation.addByPrefix('singDOWNmiss', 'BF Icon Miss', 24, false);
			...
			case 'bf-cyber':
				frames = Paths.getSparrowAtlas('characters/bf-cyber');
				animation.addByPrefix('idle', 'cbf_idle00', 24, false);
				animation.addByPrefix('singUP', 'cbf_up00', 24, false);
				animation.addByPrefix('singLEFT', 'cbf_left00', 24, false);
				animation.addByPrefix('singRIGHT', 'cbf_right00', 24, false);
				animation.addByPrefix('singDOWN', 'cbf_down00', 24, false);
			...
			case 'v-rage':
				frames = Paths.getSparrowAtlas('characters/v-rage');
				animation.addByPrefix('idle', 'vrage_idle', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singUP', 'vrage_up', 24, false);
					animation.addByPrefix('singRIGHT', 'vrage_left', 24, false);
					animation.addByPrefix('singLEFT', 'vrage_right', 24, false);
			...
			case 'airmarshal':
				frames = Paths.getSparrowAtlas('characters/air_marshal');
				animation.addByPrefix('idle', 'air marshal idle00', 24, true);
				if (isPlayer)
				{
					animation.addByPrefix('singUP', 'air marshal singUP00', 24, false);
					animation.addByPrefix('singLEFT', 'air marshal singLEFT00', 24, false);
					animation.addByPrefix('singRIGHT', 'air marshal singRIGHT00', 24, false);
					animation.addByPrefix('singDOWN', 'air marshal singDOWN00', 24, false);
				}
			...
			case 'afton':
				frames = Paths.getSparrowAtlas('characters/afton');
				animation.addByPrefix('idle', 'afton af idle', 2, false);
				animation.addByPrefix('singUP', 'afton af up', 12, false);
				animation.addByPrefix('singLEFT', 'afton af left', 12, false);
				animation.addByPrefix('singRIGHT', 'afton af right', 12, false);
				animation.addByPrefix('singDOWN', 'afton af down', 12, false);
			...
			case 'mario':
				...
				setGraphicSize(Std.int(width) * 13);
				updateHitbox();
			...
			case 'tankman':
				//PHANTOMARCADE CAN YOU /PLEASE/ JUST CONSISTENTLY USE THE SAME CAPTIALIZATION FOR YOUR ANIMATIONS JESUS FUCK
				frames = Paths.getSparrowAtlas('characters/tankman');
				animation.addByPrefix('idle', 'Tankman Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'Tankman UP note00', 24, false);
				animation.addByPrefix('singRIGHT', 'Tankman Note Left00', 24, false);
				animation.addByPrefix('singLEFT', 'Tankman Right Note00', 24, false);
				animation.addByPrefix('singDOWN', 'Tankman DOWN note00', 24, false);
				animation.addByPrefix('singUPmiss', 'Tankman UP note MISS00', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'Tankman Note Left MISS00', 24, false);
				animation.addByPrefix('singLEFTmiss', 'Tankman Right Note MISS00', 24, false);
				animation.addByPrefix('singDOWNmiss', 'Tankman DOWN note MISS00', 24, false);
			...
			case 'jacket':
				...
				frames = Paths.getSparrowAtlas('characters/jacket');
		...
		else if (curCharacter.startsWith('bf') || curCharacter.startsWith('nobody'))
			flipLeftRight();
