//shoutout to Gaktan on shadertoy for this one: https://www.shadertoy.com/view/Ms3XWH
...
void main()
{
   ...
   /* vec2 offsetR = vec2(0.006 * sin(iTime), 0.0) * colorOffsetIntensity;
    ...
    float r = texture2D(bitmap, uv).r; //was uv + offsetR
    float g = texture2D(bitmap, uv).g; //was uv + offsetG
